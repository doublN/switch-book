...
const Profile = ({ navigation }) => {
    ...
    return (
        <View>
            <Image style={styles.profileImage} resizeMode="stretch" source={{uri : currentUser.selectedImage}} />
           <View >
            <Text style={styles.body}>Welcome, {currentUser.username}!</Text>
            <Text style={styles.body}>
            <FontAwesomeIcon icon={faLocationDot}/>{currentUser.location}</Text>
           </View>
            ...
            <Pressable
                ...
                ><Text styles={styles.text}>Add a book</Text></Pressable>
            <Pressable
                style={styles.button}
